...
This repository contains the SQL file and the reports of this spatial database design project. The data for this project were obtained from the National Park Service (NPS) and the United States Department of Agriculture, Forest Service (USDA-FS). The database we created can be download <a href='https://KCivilEnGI.github.io/Spatial_DB_Design/31c278cb01d5e17b261699182fdac56b292816aa/NP_Database_postgres_Group1.sql'>here</a>
